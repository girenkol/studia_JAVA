...
\begin{enumerate}
    ...
    \item \textbf{Implementacja klasyczna}: Metoda \texttt{startClassic()} tworzy listę obiektów \texttt{Thread}, z których każdy zarządza jednym zadaniem.
...
\subsection{Logika Zadania (WorkerTask)}
